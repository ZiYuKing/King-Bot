...
namespace SysBot.Pokemon
{
    ...
    public class PokeDataOffsetsSV
    {
        ...
        public IReadOnlyList<long> BoxStartPokemonPointer { get; } = new long[] { 0x46445E8, 0xA90, 0x9D0, 0x0 };//1b1s指针,EC
        public IReadOnlyList<long> LinkTradePartnerPokemonPointer { get; } = new long[] { 0x461AE58, 0x48, 0x58, 0x40, 0x148 };
        public IReadOnlyList<long> LinkTradePartnerNIDPointer { get; } = new long[] { 0x4616450, 0x10, 0x28 };//NID指针,NID
        ...
        public IReadOnlyList<long> PortalBoxStatusPointer { get; } = new long[] { 0x4644568, 0x20, 0x40, 0x8, 0x2E8, 0x228, 0x28, 0x28 };  // 9-A in portal, 4-6 in box.
